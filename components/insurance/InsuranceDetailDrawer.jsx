...
import {
  X, Clock, ShieldAlert, AlertTriangle, CheckCircle2, Circle, MessageSquarePlus,
  Save, Lock, FileText, Calendar, Flag, ArrowRight, Activity, DollarSign,
} from 'lucide-react';
...
const InsuranceDetailDrawer = ({ claim, onClose, onUpdate }) => {
        ...
        <div className="drawer-body">
          ...
          <div className="detail-section">
            ...
            {isInsuranceEditor && claim.status === 'Closed' && (
              <button className="reopen-btn" onClick={handleToggleComplete}>
