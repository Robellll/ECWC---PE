...
import {
  plantTypeLabel, plantStatusDisplayLabel, materialCategoryLabel,
  projectStatusLabel, demandPriorityLabel, demandStatusLabel, shiftLabel,
  demandCompletionPct, plantDownReasonLabel,
} from './constants.js';
...
export function mapProdPlant(row, projectName = '') {
  ...
  return {
    ...
    statusReasonLabel: plantDownReasonLabel(row.status_reason),
    statusLabel: plantStatusDisplayLabel(row.status, row.status_reason),
