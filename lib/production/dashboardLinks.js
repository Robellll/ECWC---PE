...
export const PRIMARY_KPI_CARDS = [
  ...
  { label: 'Active Plants', valueKey: 'activePlants', href: '/production/plants?status=running' },
...
export const INTELLIGENCE_KPI_CARDS = [
  ...
  },
  {
    ...
    href: '/production/plants?status=running',
...
export const ALERT_LINKS = {
  ...
  maintenance: '/production/plants?status=maintenance',
};
